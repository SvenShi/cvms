    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['interviewee:interviewee:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="应聘岗位" prop="job">
          <el-input v-model="form.job" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="期望薪资" prop="salary">
...
<script>
import { listInterviewee, getInterviewee, delInterviewee, addInterviewee, updateInterviewee } from "@/api/interviewee/interviewee";
