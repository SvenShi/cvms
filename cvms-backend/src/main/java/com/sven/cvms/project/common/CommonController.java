package com.sven.cvms.project.common;
...
import com.sven.cvms.framework.config.ServerConfig;
...
public class CommonController {
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response,
        ...
        try {
            ...
            String filePath = CvmsConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception {
        try {
            // 上传文件路径
            String filePath = CvmsConfig.getUploadPath();
            // 上传并返回新文件名称
    ...
    public void resourceDownload(String resource, HttpServletRequest request,
        ...
        try {
            ...
            // 本地资源路径
            String localPath = CvmsConfig.getProfile();
            // 数据库资源地址
